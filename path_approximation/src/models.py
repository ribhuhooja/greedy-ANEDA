...
def run_neural_net(datasets):
    ...
    params = {'batch_size': 1000,  'hidden_units_1': 200, 'hidden_units_2': 100, 'hidden_units_3': 50, 'do_1': 0.2, 
              'do_2': 0.1, 'do_3': 0.05, 'output_size': 1, 'lr': 0.001, 'min_lr': 1e-5, 'max_lr': 1e-3, 
              'epochs': 200, 'lr_sched': 'clr', 'lr_sched_mode': 'triangular', 'gamma': 0.95}
